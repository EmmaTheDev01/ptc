                            ...
                            <article className="bg-white p-6 mb-6 shadow transition duration-300 group transform hover:-translate-y-2 hover:shadow-2xl rounded-2xl cursor-pointer border" onClick={handleWatchAd}>
                                ...
                                <div className="relative mb-4 rounded-2xl" onClick={handleWatchAd}>
                                    ...
                                    <div className="absolute bottom-3 left-3 inline-flex items-center rounded-lg bg-white p-2 shadow-md">
                                        ...
                                        <span className="ml-1 text-sm text-slate-400">0</span>
                                    </div>
                                    <a
                                        ...
                                        href="https://guriraline.netlify.app"
                                        target="_blank"
                                ...
                                <div className="flex justify-between items-center w-full pb-4 mb-auto" onClick={handleWatchAd}>
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-1">
                                            <div>
                                                <p className="text-sm font-semibold">Guriraline</p>
                                                <p className="text-sm text-gray-500">Published on 24/06/2024</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <h3 className="font-medium text-xl leading-8">
                                    <a href="https://guriraline.netlify.app" className="block relative group-hover:text-[#29625d] transition-colors duration-200">
                                        Make an order of 1 product
                                    </a>
                                </h3>
                            </article>
