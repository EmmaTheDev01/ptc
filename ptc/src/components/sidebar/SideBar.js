  ...
  return (
    <div>
      ...
      <button
        ...
        className="p-2 text-gray-500 rounded-md lg:hidden focus:outline-none focus:bg-gray-200"
      >
        <svg
          className="w-6 h-6"
          fill="none"
      ...
      <aside
        ...
        } lg:flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l`}
      >
        <div className="flex flex-col justify-between flex-1 mt-6">
          <nav className="-mx-3 space-y-6">
            ...
            >
              ...
              <span className="mx-2 text-sm font-medium">Approved Requests</span>
            </Link>
          </nav>
        </div>
      </aside>
